...
export const Route = createFileRoute("/surprise/upsell")({
  head: () => ({
    meta: [
      { title: "Oferta especial — Kit Surpresa Premium" },
...
function UpsellPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-soft px-4 py-12">
      <div className="max-w-lg mx-auto">
        ...
        <div className="mt-8 rounded-3xl border border-primary/25 bg-card p-6 sm:p-8 shadow-card">
          ...
          <p className="text-2xl font-display text-primary mt-2">{formatBRL(UPSELL_KIT.priceCents)}</p>
